...
//    }
    ...
    public String insert(String id, String firstname, String lastname, String email, String phone, String hiredate, String jobid, String salary, String commission, String managerid, String depid) {
        String result = "";
        Employees employees = new Employees(Integer.parseInt(id), firstname, lastname, email, phone, hiredate, jobid, Integer.parseInt(salary), Integer.parseInt(commission), Integer.parseInt(managerid), Integer.parseInt(depid));
    ...
    public String update(String id, String firstname, String lastname, String email, String phone, String hiredate, String jobid, String salary, String commission, String managerid, String depid) {
        Employees e = new Employees(Integer.parseInt(id), firstname, lastname, email, phone, hiredate, jobid, Integer.parseInt(salary), Integer.parseInt(commission), Integer.parseInt(managerid), Integer.parseInt(depid));
        if (edao.update(e)) {
