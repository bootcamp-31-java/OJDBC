...
public class EmployeesDAO implements IEmployeesDAO{
    ...
    public List<Employees> getAll() {
        ...
        try {
            ...
            while (rs.next()) {
                Employees e = new Employees(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(6), rs.getString(7), rs.getInt(8), rs.getInt(9), rs.getInt(10), rs.getInt(11));
                listEmployees.add(e);
            }
        } catch (Exception e) {
            e.getStackTrace();
    ...
    public boolean update(Employees em) {
        ...
        try {
            ...
            preparedStatement.setInt(8, em.getCommission());
